...
const DEFINITIONS = [
  { label: 'Gemini 3.7 Flash', key: 'gemini-3.7-flash', env: 'MEETFLOO_BENCHMARK_GEMINI_37_FLASH_MODEL' },
  { label: 'Gemini 3.1 Flash-Lite', key: 'gemini-3.1-flash-lite', env: 'MEETFLOO_BENCHMARK_GEMINI_31_FLASH_LITE_MODEL' },
  { label: 'Gemini 3.5 Flash-Lite', key: 'gemini-3.5-flash-lite', env: 'MEETFLOO_BENCHMARK_GEMINI_35_FLASH_LITE_MODEL' },
] as const;
