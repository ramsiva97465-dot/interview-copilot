...
//   "who are you?" / "what is your name?" → "I'm MeetFloo, an AI assistant." (WRONG)
...
describe('Manual identity — candidate first-person, never "I\'m MeetFloo"', () => {
...
describe('Manual assistant-meta — answers about the app, NOT the candidate', () => {
  for (const q of ['are you an AI?', 'what is MeetFloo?', 'who made MeetFloo?', 'what model are you?']) {
