...
export class WindowHelper {
  ...
  public syncLauncherTaskbarForStealth(): void {
    ...
    const isUndetectable = !!this.appState.getUndetectable();
    ...
    try {
      ...
      for (const w of allWindows) {
        ...
        if (w === this.launcherWindow) {
          w.setSkipTaskbar(isUndetectable);
        } else {
  ...
  public createWindow(): void {
    ...
    const launcherSettings: Electron.BrowserWindowConstructorOptions = {
      ...
      skipTaskbar: process.platform === 'win32' ? !!this.appState.getUndetectable() : false,
