...
const env = {
  ...
  MEETFLOO_CONTEXT_OS: '1', MEETFLOO_CONTEXT_OS_WTA: '1', MEETFLOO_CONTEXT_OS_PROPERTY_VALIDATION: '1',
...
const verdict = {
  deadline: { preview: deadline.slice(0, 140), says_sept30: /september 30|sept.*30|9\/30/i.test(deadline), leaks_profile: /MeetFloo|typescript|electron/i.test(deadline) },
  ...
  blocker: { preview: blocker.slice(0, 140), says_auth: /authentication|auth migration/i.test(blocker), leaks_profile: /MeetFloo|kubernetes/i.test(blocker) },
};
