...
const env = { ...process.env, MEETFLOO_E2E: '1', MEETFLOO_API_URL: 'http://localhost:3000', NODE_ENV: 'development', MEETFLOO_DEV_BYPASS_SCREEN_TCC: '1', MEETFLOO_E2E_LOCAL_TEST_TOKEN: 'local-test', OPENAI_API_KEY: '', OLLAMA_URL: 'http://127.0.0.1:1', MEETFLOO_GEMINI_EMBED_DIMS: '768' };
