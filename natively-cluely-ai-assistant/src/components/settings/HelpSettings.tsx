                        ...
                        <motion.div key="usage" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }} transition={{ duration: 0.2 }} className="space-y-4">
                            ...
                            <div className="flex items-start gap-3">
                                <div className="mt-0.5 w-5 h-5 rounded-full bg-bg-input flex items-center justify-center border border-border-subtle shrink-0">
                                    <img src={MeetFlooIcon} alt="AI" className="w-3 h-3 opacity-50 object-contain force-black-icon" />
                                </div>
                                <div>
    ...
    return (
        <div className="flex justify-center flex-col items-center gap-4 py-8 bg-bg-card rounded-xl border border-border-subtle relative overflow-hidden h-[240px]">
            <div className="w-[300px] bg-bg-elevated border border-border-subtle rounded-xl shadow-lg p-4 z-10">
                ...
                <div className="flex justify-between items-center">
                    <div className="flex items-center gap-2">
                        <img src={MeetFlooIcon} alt="MeetFloo" className="w-6 h-6 object-contain rounded drop-shadow-sm opacity-90" />
                        <span className="text-text-primary text-sm font-medium">MeetFloo</span>
                    </div>
            ...
            <div className="text-xs text-text-secondary text-center max-w-[280px]">
                {isMac
                    ? 'MeetFloo requires Accessibility and Screen Recording permissions to analyze screen context.'
                    : 'MeetFloo will ask for microphone access the first time you start a meeting.'}
            </div>
        </div>
    );
};
        ...
        <div className="mt-4 space-y-2.5">
            ...
            <div className="flex items-center gap-3 p-3 bg-bg-elevated border border-border-subtle rounded-xl">
                <div className="w-8 h-8 rounded-full bg-bg-item-active flex items-center justify-center border border-border-muted shrink-0 shadow-sm">
                    <img src={MeetFlooIcon} alt="Logo" className="w-[18px] h-[18px] object-contain force-black-icon opacity-90" />
                </div>
...
const MockProviderSelectionAnim = () => {
    ...
    const options = [
        { id: 'MeetFloo', label: 'MeetFloo API', badge: '', recommended: true, desc: 'Ultra-fast low latency transcription', color: 'indigo', icon: <img src={MeetFlooIcon} className={`w-[14px] h-[14px] object-contain opacity-80 ${isLight ? '' : 'filter brightness-0 invert'}`} alt="MeetFloo" /> },
    ...
    const steps = [
        {
            ...
            desc: isMac
                ? 'Enable Screen Recording and Accessibility for MeetFloo in macOS Privacy & Security.'
                : 'Approve the microphone prompt the first time you start a meeting (Settings → Privacy → Microphone).',
        },
        {
            title: 'Set Up Audio',
            desc: 'Open Settings → Audio and select MeetFloo API, or paste a Deepgram or Google key.',
        },
        {
    ...
    return (
        <div className="mb-10">
            <div className="mb-7">
                ...
                <p className="text-[13px] text-text-tertiary mt-0.5">Get MeetFloo running in four steps.</p>
            </div>
...
export const HelpSettings: React.FC<{ onNavigate?: (tab: string) => void }> = ({ onNavigate: _onNavigate }) => {
    const { shortcuts } = useShortcuts();
    const isLight = useResolvedTheme() === 'light';

    // Kbd class applying theme variables MeetFloo
        ...
        <div className="w-full h-full flex flex-col animated fadeIn pb-10">
            <header className="mb-2 shrink-0">
                ...
                <p className="text-xs text-text-secondary mb-2">
                    Learn how to deeply configure MeetFloo. Everything from providing the right API scopes to executing conversational interviews seamlessly is covered below.
                </p>
            </header>
            ...
            <div className="flex-1 space-y-2" data-settings-stagger>
                ...
                <AccordionSection title="1. App Permissions Setup" icon={<Monitor className="w-4 h-4" />}>
                    <div className="space-y-4">
                        <p>
                            {isMac
                                ? 'MeetFloo operates entirely on-device, but requires OS permissions to tap into your screen context and global keystrokes. Here is how your system should look:'
                                : 'MeetFloo operates entirely on-device. Windows will prompt you for microphone access the first time you start a meeting — no other OS permissions are required.'}
                        </p>
                        ...
                        <div className="space-y-3 mt-4">
                            ...
                            <div className={`p-4 rounded-xl border bg-bg-item-surface border-border-subtle space-y-2`}>
                                ...
                                <p className="text-[11px] opacity-90 leading-relaxed text-text-secondary">
                                    MeetFloo can capture both what you say and what you hear globally. At the top of the Audio Settings, use the Dropdowns to explicitly select your hardware Input (e.g. your physical microphone) and Output capture (what the speakers play). By default, MeetFloo utilizes the <strong>System Default</strong>, so audio routing will automatically follow your OS preferences.
                                </p>
                            </div>
                        ...
                        {isMac ? (
                            <div className="flex flex-col gap-3 mt-6">
                                <div className={`p-4 rounded-xl border bg-bg-item-surface border-border-subtle`}>
                                    ...
                                    <p className="text-xs opacity-90 mb-2">Provides MeetFloo the ability to read your screen temporarily when you capture context.</p>
                                ...
                                <div className={`p-4 rounded-xl border bg-bg-item-surface border-border-subtle`}>
                                    ...
                                    <p className="text-xs opacity-90 mb-2">Required for MeetFloo to detect the global keyboard shortcuts below, regardless of what window is focused.</p>
                ...
                <AccordionSection title="2. Audio STT Providers Setup (Microphone)" icon={<Mic className="w-4 h-4" />}>
                    <div className="space-y-6">
                        <p>MeetFloo supports over 8 different Audio engines to transcribe what you hear and say. From the Audio tab in settings, use the overarching dropdown to switch the active engine.</p>
                ...
                <AccordionSection title="3. AI Providers & Prompt Engine" icon={<Key className="w-4 h-4" />}>
                    <div className="space-y-4">
                        <p className="text-sm">MeetFloo uses Large Language Models (LLMs) to reason about your screen and audio context. You can configure cloud providers, local models, or fully custom endpoints.</p>
                        ...
                        <div className="space-y-3 pt-2">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                ...
                                <div className="p-3 rounded-xl border bg-bg-item-surface border-border-subtle hover:border-border-muted transition-colors">
                                    <h5 className="font-semibold text-sm text-text-primary flex justify-between items-center mb-1">
                                        <span className="flex items-center gap-2">
                                            <svg className={`w-3.5 h-3.5 ${isLight ? 'text-black' : 'text-white'}`} viewBox="0 0 24 24" fill="currentColor"><path d="M22.2819 9.8211a5.9847 5.9847 0 0 0-.5157-4.9108 6.0462 6.0462 0 0 0-6.5098-2.9A6.0651 6.0651 0 0 0 4.9807 4.1818a5.9847 5.9847 0 0 0-3.9977 2.9 6.0462 6.0462 0 0 0 .7427 7.0966 5.98 5.98 0 0 0 .511 4.9107 6.051 6.051 0 0 0 6.5146 2.9001A5.9847 5.9847 0 0 0 13.2599 24a6.0557 6.0557 0 0 0 5.7718-4.2058 5.9894 5.9894 0 0 0 3.9977-2.9001 6.0557 6.0557 0 0 0-.7475-7.0729zm-9.022 12.6081a4.4755 4.4755 0 0 1-2.8764-1.0408l.1419-.0804 4.7783-2.7582a.7948.7948 0 0 0 .3927-.6813v-6.7369l2.02 1.1686a.071.071 0 0 1 .038.052v5.5826a4.504 4.504 0 0 1-4.4945 4.4944zm-9.6607-4.1254a4.4708 4.4708 0 0 1-.5346-3.0137l.142.0852 4.783 2.7582a.7712.7712 0 0 0 .7806 0l5.8428-3.3685v2.3324a.0804.0804 0 0 1-.0332.0615L9.74 19.9502a4.4992 4.4992 0 0 1-6.1408-1.6464zM2.3408 7.8956a4.485 4.485 0 0 1 2.3655-1.9728V11.6a.7664.7664 0 0 0 .3879.6765l5.8144 3.3543-2.0201 1.1685a.0757.0757 0 0 1-.071 0l-4.8303-2.7865A4.504 4.504 0 0 1 2.3408 7.872zm16.5985 3.8558L13.1038 8.364 15.1192 7.2a.0757.0757 0 0 1 .071 0l4.8303 2.7913a4.4944 4.4944 0 0 1-.6765 8.1042v-5.6772a.79.79 0 0 0-.4047-.6669zm2.0107-3.0231l-.142-.0852-4.7735-2.7818a.7759.7759 0 0 0-.7854 0L9.409 9.2297V6.8974a.0662.0662 0 0 1 .0284-.0615l4.8303-2.7866a4.4992 4.4992 0 0 1 6.6802 4.66zM8.3065 12.863l-2.02-1.1638a.0804.0804 0 0 1-.038-.0567V6.0742a4.4992 4.4992 0 0 1 7.3757-3.4537l-.142.0805L8.704 5.459a.7948.7948 0 0 0-.3927.6813zm1.0976-2.3654l2.602-1.4998 2.6069 1.4998v2.9994l-2.5974 1.4997-2.6067-1.4997Z"/></svg> OpenAI
                                        </span>
                                ...
                                <div className="p-3 rounded-xl border bg-bg-item-surface border-border-subtle hover:border-border-muted transition-colors">
                                    <h5 className="font-semibold text-sm text-text-primary flex justify-between items-center mb-1">
                                        <span className="flex items-center gap-2">
                                            <svg className="w-3.5 h-3.5 text-blue-500" viewBox="0 0 24 24" fill="currentColor"><path d="M12.48 10.92v3.28h7.84c-.24 1.84-.853 3.187-1.787 4.133-1.147 1.147-2.933 2.4-6.053 2.4-4.827 0-8.6-3.893-8.6-8.72s3.773-8.72 8.6-8.72c2.6 0 4.507 1.027 5.907 2.347l2.307-2.307C18.747 1.44 16.133 0 12.48 0 5.867 0 .307 5.387.307 12s5.56 12 12.173 12c3.573 0 6.267-1.173 8.373-3.36 2.16-2.16 2.84-5.213 2.84-7.667 0-.76-.053-1.467-.173-2.053H12.48z"/></svg> Google Gemini
                                        </span>
                        ...
                        <div className="space-y-3 pt-4">
                            ...
                            <div className="p-4 rounded-xl border bg-bg-item-surface border-border-subtle space-y-3">
                                <p className="text-xs opacity-90 leading-relaxed text-text-secondary">
                                    You can run MeetFloo completely offline with 100% data privacy using Ollama. MeetFloo automatically scans <span className={kbdClass}>http://localhost:11434</span> for active models.
                                </p>
                                <ol className="list-decimal pl-4 text-xs space-y-2 opacity-90 text-text-secondary">
                                    ...
                                    <li>AlterMeetFloo, for faster generation without GPU, use Microsoft's smaller model:
                            ...
                            <div className="p-4 rounded-xl border bg-bg-item-surface border-border-subtle space-y-3">
                                ...
                                <div className="flex items-start gap-2 mt-2">
                                    ...
                                    <div className="text-xs text-text-secondary leading-relaxed">
                                        <strong>Crucial: The Response Path.</strong> You must inform MeetFloo how to parse the JSON text back. Deeply nested outputs must define the exact path array. For OpenAI/OpenRouter compliant endpoints, this is strictly: <span className={kbdClass}>choices[0].message.content</span>.
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <AccordionSection title="4. MeetFloo Interface Operations" icon={<Monitor className="w-4 h-4" />}>
                    <div className="space-y-6">
                        <p className="text-[13px]">When initialized, MeetFloo hides itself visually while remaining active as a persistent translucent overlay. This is your command center.</p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                            <div className="p-4 bg-bg-item-surface border border-border-subtle rounded-xl shadow-sm hover:border-border-muted transition-colors group">
                                ...
                                <p className="text-[12px] text-text-secondary leading-relaxed">
                                    MeetFloo fires a local background job as soon as the meeting finishes to compress the entire raw audio transcript into clean, formatted markdown representing structural overviews and explicit action items.
                                </p>
                            </div>
                ...
                <AccordionSection title="6. Global Search & Shortcuts" icon={<Search className="w-4 h-4" />}>
                    <div className="space-y-6">
                        <p className="text-[13px]">Hit <span className={kbdClass}>{isMac ? 'Cmd+K' : 'Ctrl+K'}</span> anywhere on your computer to invoke the MeetFloo Global Palette. This acts as your Spotlight overlay for interacting directly with the system backbone.</p>
                        ...
                        <div className="border-t border-border-subtle pt-6">
                            ...
                            <p className="text-[11px] text-text-secondary mt-1 mb-3">These hotkeys work anywhere on your operating system, regardless of whether MeetFloo is focused or completely hidden. Change them via <strong>Settings &gt; Hotkeys</strong>.</p>
                                ...
                                <div className="flex items-center justify-between p-4 rounded-xl border bg-bg-item-surface border-border-subtle group">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-xs text-text-secondary mt-1">Triggers MeetFloo to analyze the captured screenshots and text from the rolling buffer.</div>
                                        </div>
                                    </div>
                                    <div className="flex gap-1 shrink-0">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="border-t border-border-subtle pt-5 mt-2">
                            <div className="p-3 bg-purple-500/10 border border-purple-500/20 rounded-xl mb-4">
                                ...
                                <p className="text-[11px] text-text-secondary leading-relaxed mb-0">
                                    Drop a target <strong>JD PDF</strong> alongside your resume. MeetFloo extracts the role title, level, company, and required technologies, then biases every prompt to align your responses with that exact spec — perfect for staying on-message during a final loop.
                                </p>
                            </div>
                ...
                <AccordionSection title="8. Modes Manager" icon={<LayoutGrid className="w-4 h-4" />}>
                    <div className="space-y-6">
                            ...
                            <div className="grid md:grid-cols-2 gap-3">
                                <div className="p-4 rounded-xl border bg-bg-item-surface border-border-subtle">
                                    ...
                                    <ul className="text-[11px] text-text-secondary space-y-1 list-disc pl-4">
                                        ...
                                        <li>Requires a MeetFloo Pro license</li>
                                    </ul>
                                </div>
                                <div className="p-4 rounded-xl border bg-bg-item-surface border-border-subtle">
                        ...
                        <div className="p-3 bg-indigo-500/10 border border-indigo-500/20 rounded-xl">
                            ...
                            <p className="text-[11px] text-text-secondary leading-relaxed mb-0">
                                Modes are locked behind MeetFloo Pro. Free and trial users see only the General mode. Activate a license via <strong>Settings → MeetFloo API</strong> to unlock all seven modes.
                            </p>
                        </div>
                    </div>
                </AccordionSection>
                    ...
                    <div className="space-y-6">
                        ...
                        <div>
                            <div className="p-3 bg-accent-subtle border border-accent-border rounded-xl mb-4">
                                ...
                                <p className="text-[11px] text-text-secondary leading-relaxed mb-0">
                                    By connecting your Google Calendar directly to MeetFloo, the AI automatically gains context on your upcoming meetings, syncs the event data, and reads attendee lists to hyper-personalize your interactions.
                                </p>
                            </div>
                            ...
                            <div className="grid md:grid-cols-2 gap-3">
                                <div className="p-4 rounded-xl border bg-bg-item-surface border-border-subtle">
                                    ...
                                    <ul className="text-[11px] text-text-secondary space-y-1 list-disc pl-4">
                                        ...
                                        <li>MeetFloo will quietly background-sync your schedule.</li>
                                    </ul>
                                </div>
                                <div className="p-4 rounded-xl border bg-bg-item-surface border-border-subtle">
                                    <h4 className="font-semibold text-sm mb-2 text-text-primary">Follow-Up System</h4>
                                    <p className="text-[11px] text-text-secondary">
                                        When tracking live meetings, MeetFloo uses the connected calendar context to instantly figure out <strong>who you are talking to</strong>. This powers the Follow-Up Email system, letting you auto-draft post-meeting notes to confirmed attendees.
                                    </p>
                                </div>
                                <div className="p-4 rounded-xl border bg-bg-item-surface border-border-subtle">
                                    <h4 className="font-semibold text-sm mb-2 text-text-primary flex items-center gap-2">
                    ...
                    <div className="space-y-4">
                        <div className="p-3 bg-sky-500/10 border border-sky-500/20 rounded-xl mb-2">
                            <h4 className="text-[13px] font-semibold text-sky-400 flex items-center gap-2 mb-1">
                                <Smartphone size={14} /> Stream MeetFloo to Your Phone
                            </h4>
                            <p className="text-[11px] text-text-secondary leading-relaxed mb-0">
                                Phone Mirror spins up a small local web server so you can watch MeetFloo's live transcript and AI answers from your phone or tablet — handy when your screen is being shared and you don't want the overlay visible.
                            </p>
                        </div>
                ...
                <AccordionSection title="11. Stealth & Window Control" icon={<Ghost className="w-4 h-4" />}>
                    <div className="space-y-4">
                        <div className="p-3 bg-indigo-500/10 border border-indigo-500/20 rounded-xl mb-4">
                            ...
                            <p className="text-[11px] text-text-secondary leading-relaxed mb-0">
                                MeetFloo is heavily geared towards power users seeking minimalistic operation. The process completely disguises itself and remains undetectable/invisible to standard screen-recording applications and desktop sharing utilities.
                            </p>
                        </div>
                        ...
                        <div className="grid gap-3">
                            ...
                            <div className="p-4 rounded-xl border bg-bg-item-surface border-border-subtle group">
                                ...
                                <p className="text-[11px] text-text-secondary mb-3">
                                    Google Meet, Microsoft Teams, and QuickTime hide MeetFloo automatically — nothing to configure. Zoom is the one exception: whether it respects MeetFloo's "don't capture me" flag depends on a single setting.
                                </p>
                                <p className="text-[11px] text-text-secondary mb-3">
                                ...
                                <p className="text-[11px] text-text-secondary mb-0">
                                    The "...with window filtering" modes tell Zoom to leave out windows that mark themselves as private, which is exactly what MeetFloo does. <strong>"Advanced capture without window filtering"</strong> grabs the raw screen and will show MeetFloo, so avoid it.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <AccordionSection title="12. Hindsight Long-Term Memory (LTM) Setup" icon={<Brain className="w-4 h-4" />}>
                    <div className="space-y-4">
                        <div className="p-3 bg-purple-500/10 border border-purple-500/20 rounded-xl mb-4">
                            ...
                            <p className="text-[11px] text-text-secondary leading-relaxed mb-0">
                                Hindsight is a local or cloud-based sidecar service that acts as MeetFloo's vector database. It indexes past meeting transcript segments, custom profiles, and documents to make them queryable via semantic vector search.
                            </p>
                        </div>
                        ...
                        <div className="grid gap-3">
                            ...
                            <div className="p-4 rounded-xl border bg-accent-subtle border-border-subtle group">
                                ...
                                <ol className="text-[11px] text-text-secondary space-y-2 list-decimal pl-4 mb-3">
                                    ...
                                    <li>In MeetFloo desktop: open <strong>Settings → Intelligence</strong>.</li>
...
hindsight-api`}
                                    ...
                                    <p className="text-[10px] text-text-muted mt-1 leading-relaxed">
                                        Once running, access the local dashboard UI at <code className="bg-bg-elevated px-1 font-mono text-[9px]">http://localhost:9999</code>. In MeetFloo settings, set the Base URL to <code className="bg-bg-elevated px-1 font-mono text-[9px]">http://localhost:8888</code>.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="p-4 rounded-xl border bg-bg-item-surface border-border-subtle group">
                                ...
                                <p className="text-[11px] text-text-secondary leading-relaxed mb-3">
                                    Quickly start a local developer instance using the scripts packaged with MeetFloo:
                                </p>
                                <ol className="text-[11px] text-text-secondary space-y-1 list-decimal pl-4">
                                    ...
                                    <li>From the MeetFloo project folder, run the bundled launcher: <code className="bg-bg-elevated px-1 font-mono text-[10px]">bash scripts/hindsight-start.sh</code>. It starts the embedded memory server (bundled Postgres + pgvector, no Docker) on port 8888 and wires your AI provider chain + fallback automatically.</li>
                                    <li>Set MeetFloo Base URL to <code className="bg-bg-elevated px-1 font-mono text-[10px]">http://localhost:8888</code> and toggle on memory.</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <AccordionSection title="13. Sandboxed Code Verification & Corrector" icon={<Cpu className="w-4 h-4" />}>
                    <div className="space-y-4">
                        <div className="p-3 bg-emerald-500/10 border border-emerald-500/20 rounded-xl mb-4">
                            ...
                            <p className="text-[11px] text-text-secondary leading-relaxed mb-0">
                                When a coding question is answered, MeetFloo extracts code blocks and executes them inside isolated local sandboxed processes to verify their logical correctness. Code blocks receive a "Verified ✓" badge once tested.
                            </p>
                        </div>
                        ...
                        <div className="grid gap-3">
                            ...
                            <div className="p-4 rounded-xl border bg-bg-item-surface border-border-subtle group">
                                ...
                                <p className="text-[11px] text-text-secondary leading-relaxed">
                                    If a sandboxed code block fails to compile or yields runtime errors, MeetFloo initiates a background correction request to the reasoning model, supplying the execution error logs. The corrected code is streamed back to your interface automatically.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <AccordionSection title="14. Companion Browser Extension Setup" icon={<Smartphone className="w-4 h-4" />}>
                    <div className="space-y-4">
                        <div className="p-3 bg-indigo-500/10 border border-indigo-500/20 rounded-xl mb-4">
                            ...
                            <p className="text-[11px] text-text-secondary leading-relaxed mb-0">
                                The MeetFloo browser extension (Manifest V3) allows you to securely send the active browser tab's text content and source code to the MeetFloo desktop app. It only communicates over your local loopback.
                            </p>
                        </div>
                        ...
                        <div className="grid gap-3">
                                        ...
                                        <ol className="space-y-1 list-decimal pl-4">
                                            <li>Open your terminal and run:
                                                <code className="block bg-bg-elevated p-1.5 rounded font-mono text-[9px] my-1 border border-border-subtle overflow-x-auto whitespace-pre">
                                                    cd MeetFloo-browser && npm install && npm run build
                                                </code>
                                            </li>
                                            ...
                                            <li>Click <strong>Load unpacked</strong> and select the <code className="bg-bg-elevated px-1 font-mono text-[9.5px]">MeetFloo-browser/dist</code> folder.</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="p-4 rounded-xl border bg-bg-item-surface border-border-subtle group">
                                <h4 className="font-semibold text-sm mb-2 text-text-primary flex items-center gap-2">
                                    <Zap className="w-4 h-4 text-amber-500" /> 2. Pair with MeetFloo Desktop
                                </h4>
                                <p className="text-[11px] text-text-secondary leading-relaxed mb-3">
                                    Establish a secure paired loopback connection (done only once):
                                </p>
                                <ol className="text-[11px] text-text-secondary space-y-1 list-decimal pl-4">
                                    <li>In MeetFloo desktop: go to <strong>Settings → Sync</strong>, ensure Phone Mirror is running, and under the **Browser Extension** card click <strong>Connect browser extension</strong> (arms pairing for 60s).</li>
                                    <li>In your browser: click the MeetFloo extension toolbar icon, then click <strong>Connect to MeetFloo</strong>.</li>
                            ...
                            <div className="p-4 rounded-xl border bg-bg-item-surface border-border-subtle group">
                                ...
                                <ul className="text-[11px] text-text-secondary space-y-2 list-disc pl-4">
                                    <li>
                                        <strong>Global Hotkey (Recommended):</strong> Press <kbd className="bg-bg-elevated px-1.5 py-0.5 rounded border text-[10.5px] border-border-subtle font-sans">{isMac ? '⌘' : 'Ctrl'}+Y</kbd> anywhere on your system. Keep holding {isMac ? '⌘' : 'Ctrl'} and tap Enter to send the question in the same motion. MeetFloo pulls DOM context automatically; if the browser isn't active/reachable, it defaults to a screenshot automatically.
                                    </li>
                                    <li>
                ...
                <AccordionSection title="15. Session Memory & Spoken Humanizer" icon={<Sparkles className="w-4 h-4" />}>
                    <div className="space-y-4">
                        <div className="p-3 bg-amber-500/10 border border-amber-500/20 rounded-xl mb-4">
                            ...
                            <p className="text-[11px] text-text-secondary leading-relaxed mb-0">
                                MeetFloo implements real-time session tracking, entity extraction, and stylistic rewriting. This ensures responses refer correctly to prior chat context and sound completely natural when read aloud, without robotic or repetitive patterns.
                            </p>
                        </div>
                        ...
                        <div className="grid gap-3">
                            <div className="p-4 rounded-xl border bg-bg-item-surface border-border-subtle group">
                                ...
                                <p className="text-[11px] text-text-secondary leading-relaxed mb-3">
                                    As meetings progress, MeetFloo monitors speaker turns and extracts key entities (such as projects, skills, and compensation):
                                </p>
                                <ul className="text-[11px] text-text-secondary space-y-2 list-disc pl-4">
                                    <li><strong>Demonstrative Follow-ups:</strong> If you ask "Tell me more about <em>that project</em>", MeetFloo resolves the pronoun to the specific project name discussed previously (e.g. "MeetFloo").</li>
