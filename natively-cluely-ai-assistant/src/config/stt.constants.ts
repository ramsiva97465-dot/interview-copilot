...
export type SttProviderId = 'google' | 'groq' | 'openai' | 'deepgram' | 'elevenlabs' | 'azure' | 'ibmwatson' | 'MeetFloo';
...
export const STT_PROVIDERS: Record<SttProviderId, SttProviderConfig> = {
    ...
    MeetFloo: {
        id: 'MeetFloo',
        name: 'MeetFloo Pro (Managed)',
        description: 'All-in-one managed STT via MeetFloo API',
        endpoint: '',
        model: '',
        uploadType: 'websocket',
        authHeader: () => ({}),
