...
/** Interviewer-side prefilter: a candidate that is nothing but acknowledgements/closings never costs a judge call. */
export const USER_BACKCHANNEL = /^(?:(?:yeah|yes|yep|yup|ya|mm-?hm+|mhm+|uh-?huh|ok(?:ay)?|right|sure|cool|got it|i see|nice|great|perfect|exactly|interesting|makes sense|sounds good|true|correct|wow|oh|ah|hm+|haha+|alright|of course|fair enough|no problem|totally|absolutely|definitely|indeed|good|fine|thanks?|thank you|thank you so much|thank you very much|thank you for your time|that'?s all|that is all|that'?s all for now|that'?s all from my side|we will get back to you|we'?ll get back to you|we'?ll be in touch|have a (?:great|good|nice) day|nice meeting you|good luck|take care|done)[\s,.!?-]*){1,5}$/i;
