...
/**
 * HuggingFace ONNX Embedding download provider.
 * Allows users to download and manage local embedding models for RAG.
 */
export function createEmbeddingDownloadProvider(): LocalModelDownloadProvider {
  const { createEmbeddingDownloadProvider: factory } = require('../rag/embeddingDownloadProvider') as typeof import('../rag/embeddingDownloadProvider');
  return factory();
}
