...
const app = await electron.launch({ args: ['dist-electron/electron/main.js'], env: { ...process.env, MEETFLOO_E2E: '1', MEETFLOO_API_URL: 'http://localhost:3000', NODE_ENV: 'development', MEETFLOO_DEV_BYPASS_SCREEN_TCC: '1', MEETFLOO_E2E_LOCAL_TEST_TOKEN: 'local-test' }, timeout: 60000 });
