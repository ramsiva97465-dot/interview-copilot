            ...
            >
                <div className="flex items-center justify-between gap-3">
                    <div className="flex items-center gap-2 min-w-0 flex-1 flex-wrap sm:flex-nowrap">
                        ...
                        {m.recommended && m.supported && (
                            <AipBadge
                                tone="info"
                                label={
                                    m.id.includes('ettin')
                                        ? t('Recommended · Commercial')
                                        : m.id.includes('jina')
                                            ? t('Recommended · Max Accuracy')
                                            : t('Recommended')
                                }
                            />
                        )}
            ...
            <div className="aip-card aip-provider space-y-3">
                ...
                <div className="flex items-center justify-between gap-3 flex-wrap text-[10px] aip-muted px-1">
                    <p className="min-w-0 flex-1">
                        <strong className="text-white/80">{t('Reranker (Answer Precision): ')}</strong>
                        {t('Re-scores and re-orders search results so the exact right answer appears at the very top. Runs 100% on this device with zero data sent externally.')}
                    </p>
