...
const RETRIEVAL_TABS = [
    { id: 'embedding' as const, label: '1. Embedding (Search Index)', Icon: Boxes },
    { id: 'reranker' as const, label: '2. Reranker (Answer Precision)', Icon: ListOrdered },
];
    ...
    return (
        ...
        <div className="aip-root space-y-5 pb-10" data-theme={aipTheme} data-settings-stagger>
            ...
            <header className="space-y-1">
                <h3 className="aip-title">{t('Retrieval Pipeline')}</h3>
                <p className="aip-subtitle">
                    {t('Two models work together to search your documents and meetings: Step 1 (Embedding) indexes content so it can be quickly found by meaning, and Step 2 (Reranker) scores and sorts those search results to put the most exact answer at the very top.')}
                </p>
            </header>
