...
const MeetFlooInterfaceCard = ({ className = "", isMobile = false, isStatic = false, hidePill = false, hideMessages = false, dreamyVariant = false, spreadHotkeys = false }: Props) => {
        ...
        {!hidePill && (
          ...
          >
            ...
            <div className="w-8 h-8 rounded-full flex items-center justify-center relative overflow-hidden" style={DARK_GLASS}>
              {GLOSS}
              <img src={MeetFlooLogo} alt="MeetFloo" className="w-[28px] h-[28px] object-contain relative" draggable={false} />
            </div>
            ...
            <div className="relative">
              ...
              >
                {dreamyVariant ? (
                  ...
                  "Ask anything — MeetFloo knows your resume and this company..."
                )}
              </div>
            </div>
...
export default MeetFlooInterfaceCard;
